...
process split_conf {
    ...
    output:
    file(conf_file_1) into conf_first_run_ch
...
process run_denovomagic_part_1 {
    ...
    input:
    file(conf_file_1) from conf_first_run_ch
    file(conf_file)

//    output:
    //first run output

    script: //second row should be replaced with running dm
    """
...
process run_denovomagic_part_2 {
    publishDir publish_dir
    echo true
